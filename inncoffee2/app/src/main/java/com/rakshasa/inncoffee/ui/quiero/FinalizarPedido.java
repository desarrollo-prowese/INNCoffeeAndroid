...
public class FinalizarPedido extends Fragment {
    ...
    private void MisPuntos(){
        ...
        MisPuntos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick (View v) {
                Log.v("QUE CUANTOS PUNTOS", puntoss + " // "+ total);
    ...
    private void moveGameRoom() {
        mUsuario.child("PedidosFinalizados").child(ID).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                mComanda.child(ID).child("ImprimirLista").child(Comanda).setValue(dataSnapshot.getValue(), new DatabaseReference.CompletionListener() {
                    @Override
        ...
        mUsuario.child("PedidosFinalizados").child(ID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    mAdapter = new AdapterPedidos(getActivity(), keys, mMensaje,  R.layout.contenido_mispedidos);
