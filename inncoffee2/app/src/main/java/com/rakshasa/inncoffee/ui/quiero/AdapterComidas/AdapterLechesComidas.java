package com.rakshasa.inncoffee.ui.quiero.AdapterComidas;
...
public class AdapterLechesComidas extends RecyclerView.Adapter<AdapterLechesComidas.ViewHolder> {
    ...
    public AdapterLechesComidas (Context mContext, ArrayList<MisPedidosClass> mensajeslist, ArrayList<String> keys, int resource){
    ...
    public void setOnItemClickListener(AdapterLechesComidas.OnItemClickListener listener) {
        mListener = listener;
    }
    ...
    public class ViewHolder extends  RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view,final AdapterLechesComidas.OnItemClickListener listener) {
            super(view);
            this.view = view;
