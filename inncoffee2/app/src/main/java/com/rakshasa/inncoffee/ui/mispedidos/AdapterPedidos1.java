...
public class AdapterPedidos1 extends RecyclerView.Adapter<AdapterPedidos1.ViewHolder> {
    ...
    public AdapterPedidos1 (Context mContext, ArrayList<String> keys, ArrayList<MisPedidosClass> mensajeslist, int resource){
    ...
    public void setOnItemClickListener(AdapterPedidos1.OnItemClickListener listener) {
        mListener = listener;
    }
    ...
    public class ViewHolder extends  RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view,final AdapterPedidos1.OnItemClickListener listener) {
            super(view);
            this.view = view;
