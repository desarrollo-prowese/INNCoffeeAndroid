...
public class AdapterComidas extends RecyclerView.Adapter<AdapterComidas.ViewHolder> {
    ...
    public AdapterComidas (Context mContext, ArrayList<MisPedidosClass> mensajeslist, ArrayList<String> keys, int resource){
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.desc.setText(mensajes.getPrecio2());
    ...
    public void setOnItemClickListener(AdapterComidas.OnItemClickListener listener) {
        mListener = listener;
    }
    ...
    public class ViewHolder extends  RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view,final AdapterComidas.OnItemClickListener listener) {
            super(view);
            this.view = view;
            this.desc = (TextView) view.findViewById(R.id.textomensaje2) ;
