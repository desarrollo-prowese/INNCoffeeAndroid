...
public class Postres extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("comida").child("postres");
            ...
            protected void onBindViewHolder(final ObjetosViewHolder objetosViewHolder, int i, final Postres_Model objetos) {
                ...
                objetosViewHolder.anadir.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (Menu_Completo.postreMenuCompleto.equals("1")) {
                            Intent intentMC = new Intent(view.getContext(), Menu_Completo.class);
                            Postres.Postre = objetosViewHolder.titulo.getText().toString();
                            Menu_Completo.postreMenuCompleto = "0";
