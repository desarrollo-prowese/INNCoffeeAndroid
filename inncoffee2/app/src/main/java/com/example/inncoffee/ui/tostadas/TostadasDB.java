...
public class TostadasDB {

    public TostadasDB() {

    }

    public TostadasDB(String nombrearticulo) {
    ...
    public TostadasDB(String titulo, String imagen, String nombrearticulo, String descarticulo, String tipoPan, String precio, String enteraomedia, String alojenos) {
        this.titulo = titulo;
        this.imagen = imagen;
        this.nombrearticulo = nombrearticulo;
        this.descarticulo = descarticulo;
