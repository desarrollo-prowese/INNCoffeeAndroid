...
public class TostadasExtraordinarias extends Fragment {
    ...
    private ImageView Imagen,menos,plus;
    private TextView nombreArticulo,precio,descarticulo,contador,añadir;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.tostadasextraordinarias, container, false);
        MainActivity.mensajeToolbar.setText("QUIERO / NUEVO PEDIDO");
        mDatabase = FirebaseDatabase.getInstance();
        mUser = FirebaseAuth.getInstance().getCurrentUser();
        mTosta = mDatabase.getReference("TostadasExtraordinarias");
