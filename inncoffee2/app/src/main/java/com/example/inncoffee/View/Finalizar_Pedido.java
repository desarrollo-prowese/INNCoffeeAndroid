...
public class Finalizar_Pedido extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Date date = new Date();
        double sum = 0;
        for (int i = 0; i < Pedidos_Comidas.Precio.size(); i++) {
            sum = sum + Double.parseDouble(Pedidos_Comidas.Precio.get(i));
        }
...
//
        AdapterItem adapter = new AdapterItem(this, Pedidos_Comidas.titulo, Pedidos_Comidas.Precio);
        ...
        buttonPago.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String res = String.join(",", Pedidos_Comidas.titulo);
                final String res2 = String.join(",", Pedidos_Comidas.Precio);
