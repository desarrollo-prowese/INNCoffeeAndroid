package com.example.inncoffee.ui.quiero.AdapterMerienda;
...
public class AdapterBebidasMerienda extends RecyclerView.Adapter<AdapterBebidasMerienda.ViewHolder> {
    ...
    public AdapterBebidasMerienda (Context mContext, ArrayList<MisPedidosClass> mensajeslist, ArrayList<String> keys, int resource){
    ...
    public void setOnItemClickListener(AdapterBebidasMerienda.OnItemClickListener listener) {
        mListener = listener;
    }
    ...
    public class ViewHolder extends  RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view,final AdapterBebidasMerienda.OnItemClickListener listener) {
            super(view);
            this.view = view;
