...
public class TostadasOriginales extends AppCompatActivity {
    public static String tostada = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Desayuno").child("tostadas_originales");

        options = new FirebaseRecyclerOptions.Builder<Objetos>().setQuery(databaseReference, Objetos.class).build();
        Log.e("Nombre de recuperamosVariable: ", "" + recuperamos_variable_string);
