...
public class TapaBebida extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.tapabebida, container, false);
        ...
        Log.v("Que Menus TAPAS  ", String.valueOf(tapas));


        añadir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (TextUtils.isEmpty(tapa) || TextUtils.isEmpty(beb)) {
                    ...
                    mUsuario.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            String processed = "";
                            if (contador2 == 1) {
                                String texto = contador2 + " /" + primero.getText() + "/" + bebida.getText();
    ...
    private void PrecioModificable(){
        ...
        mPrecio.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    precio = dataSnapshot.child("tapa").getValue().toString();
