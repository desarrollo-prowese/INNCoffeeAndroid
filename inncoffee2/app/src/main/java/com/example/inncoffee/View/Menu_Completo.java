...
public class Menu_Completo extends AppCompatActivity {
    static String bebidaMenuComleto = "0";
    static String postreMenuCompleto = "0";
    private Button primerPlato;
    private Button segundoPlato;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vista_menucompleto);
        primerPlato = findViewById(R.id.buttonPplato);
        segundoPlato = findViewById(R.id.buttonSPlato);
        bebida = findViewById(R.id.buttonBebida);
        postre = findViewById(R.id.buttonPostre);
        anadirCombo = findViewById(R.id.buttonAnadirC);
        ...
        segundoPlato.setText(SegundoPlato.SegundoPlato);
        ...
        segundoPlato.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View view) {
                String uid = mAuth.getCurrentUser().getUid();
                mDatabase.child("Users").child(uid).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        //System.out.println("afjasfasjf"+ Alergias);
                        Log.e("Nombre de usuario: ", "" + Alergias1);
                        Intent intent2 = new Intent(view.getContext(), SegundoPlato.class);
                        intent2.putExtra("variable_string", Alergias1);
                        startActivityForResult(intent2, 0);
        ...
        anadirCombo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                extras.putString("variable_stringComidaTitulo", primerPlato.getText().toString() + " / " + segundoPlato.getText().toString() + " / " + bebida.getText().toString() + " / " + postre.getText().toString());
