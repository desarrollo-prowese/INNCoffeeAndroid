...
public class PrimerPlato extends AppCompatActivity {
    //st String recuperamos_variable_string
    static String PrimerPlato = "Elige Primer Plato";
    public String paso;
            ...
            protected void onBindViewHolder(final ObjetosViewHolder objetosViewHolder, int i, Objetos objetos) {
                ...
                objetosViewHolder.anadir.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (Medio_Menu.medioMenu.equals("1")) {
                            Intent intent2 = new Intent(view.getContext(), Medio_Menu.class);

                            PrimerPlato = objetosViewHolder.titulo.getText().toString();
                            startActivity(intent2);
                        } else if (Medio_Menu.medioMenu.equals("2")) {
                            Intent intent2 = new Intent(view.getContext(), Menu_Tapas.class);
