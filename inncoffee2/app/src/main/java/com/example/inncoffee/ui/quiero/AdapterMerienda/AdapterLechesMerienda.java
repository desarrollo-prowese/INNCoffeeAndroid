...
public class AdapterLechesMerienda extends RecyclerView.Adapter<AdapterLechesMerienda.ViewHolder> {
    ...
    public AdapterLechesMerienda (Context mContext, ArrayList<MisPedidosClass> mensajeslist, ArrayList<String> keys, int resource){
    ...
    public void setOnItemClickListener(AdapterLechesMerienda.OnItemClickListener listener) {
        mListener = listener;
    }
    ...
    public class ViewHolder extends  RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view,final AdapterLechesMerienda.OnItemClickListener listener) {
            super(view);
            this.view = view;
